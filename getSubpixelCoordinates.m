function [subpixelRedCoordinates] = getSubpixelCoordinates(K)
    % 赤色のピクセル座標を取得
    ...
    subpixelRedCoordinates = replacement(subpixelRedCoordinates);
end
...
function subpixelRedCoordinates = replacement(subpixelRedCoordinates)
    % 全ての座標の1列目と2列目を入れ替える
